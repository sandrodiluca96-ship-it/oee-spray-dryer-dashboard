...
tab_turno, tab_lotti, tab_qualita, tab_cruscotto, tab_formule, tab_prodotti, tab_config, tab_gestione = st.tabs([
    "Turno",
    "Lotti in corso",
    "Qualità",
    "Cruscotto OEE",
    ...
    with st.form("form_evento", clear_on_submit=False):
        ...
        if tipo_evento == "Produzione":
            ...
            if tipo_produzione == "Apertura lotto":
                ...
                scelta = st.selectbox("Lotto aperto", options, key="lotto_aperto_prosecuzione")
                ...
                lotti_aperti = lista_lotti_aperti()
                options = ["-- Seleziona lotto aperto --"] + lotti_aperti
                scelta = st.selectbox("Lotto aperto", options, key="lotto_aperto_chiusura")
...
with tab_config:
    ...
    st.dataframe(causali, use_container_width=True)
...
with tab_gestione:
    ...
    if eventi.empty:
        ...
        st.dataframe(ultimi_eventi, use_container_width=True)
