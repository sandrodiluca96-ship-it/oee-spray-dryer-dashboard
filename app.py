...
with tab_turno:
    ...
    c0, c1 = st.columns(2)
    with c0:
        data_turno = st.date_input("Data turno", value=None, format="DD/MM/YYYY", key="header_data_turno")
    with c1:
        turno_sel = st.selectbox("Turno", ["-- Seleziona turno --", "1", "2", "3"], index=0, key="header_turno")
