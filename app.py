...
with tab_turno:
    ...
    if submit_evento or submit_modifica:
        ...
        elif tipo_evento == "Produzione" and evento["lotto_molle"].strip() == "":
            st.error("Per una produzione devi inserire il lotto molle.")
        elif tipo_evento == "Produzione" and evento["tipo_produzione"] == "Apertura lotto" and evento["codice_prodotto"].strip() == "":
            st.error("Per apertura lotto devi selezionare il prodotto.")
